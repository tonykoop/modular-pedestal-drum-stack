...
- `shell-coupling.wl` — full shell-membrane FEM-style coupling estimate
- `tuning-stability.wl` — temperature/humidity drift predictions
- `learn-to-play-scales.wl` — generate pentatonic scale exercises
